...
@section('breadcrumbs', Breadcrumbs::render('products.create'))
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h2>@lang('app.create.title', ['model' => __('products.model')])</h2>
                </div>
                <div class="card-body">
                    <form action="{{ route('products.store') }}" method="post" name="create">
                        @csrf
...
@endpush
    ...
    @endif
                        ...
                        <div class="form-group">
                            ...
                            <button type="button" class="btn btn-outline-dark" onclick="location.href='{{ route('products.index') }}'">@lang('app.cancel')</button>
                        </div>
                    </form>
                </div>
            </div>
